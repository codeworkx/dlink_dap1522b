...
#define UPGRADE_SIZE	(FLASH_SIZE - BOOTCODE_SIZE - LANGPACK_SIZE - DEVCONF_SIZE - DEVDATA_SIZE )

#define DEVDATA_OFFSET	(BOOTCODE_SIZE)
#define DEVCONF_OFFSET	(FLASH_SIZE - DEVCONF_SIZE)
#define UPGRADE_OFFSET	(BOOTCODE_SIZE + DEVDATA_SIZE)
#define LANGPACK_OFFSET	(FLASH_SIZE - DEVCONF_SIZE - LANGPACK_SIZE)
#define BOOTCFG_SIZE	0x2000
...
static struct mtd_partition elbox_partitions[] =
{
	...
	{name:"u-boot",		offset:0x000000,		size:BOOTCODE_SIZE,	mask_flags:	MTD_WRITEABLE, },
	{name:"boot env",	offset:DEVDATA_OFFSET,	size:BOOTCFG_SIZE,	mask_flags:	MTD_WRITEABLE, },
	{name:NULL,	},
};
#else
#define BOOTCODE_SIZE	0x30000
#define DEVCONF_SIZE	0x10000
#define DEVDATA_SIZE	0x10000
#define UPGRADE_SIZE	(FLASH_SIZE - BOOTCODE_SIZE - DEVCONF_SIZE - DEVDATA_SIZE - LANGPACK_SIZE - MYDLINK_SIZE)

#define DEVDATA_OFFSET	(BOOTCODE_SIZE)
#define DEVCONF_OFFSET	(BOOTCODE_SIZE + DEVDATA_SIZE)
#define UPGRADE_OFFSET	(BOOTCODE_SIZE + DEVDATA_SIZE + DEVCONF_SIZE)

#define MYDLINK_OFFSET	(BOOTCODE_SIZE + DEVDATA_SIZE + DEVCONF_SIZE + UPGRADE_SIZE)

#define LANGPACK_OFFSET	(BOOTCODE_SIZE + DEVDATA_SIZE + DEVCONF_SIZE + UPGRADE_SIZE + MYDLINK_SIZE)
