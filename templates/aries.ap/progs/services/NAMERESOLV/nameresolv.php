...
function netbios_setup($name)
{
	...
	if($addrtype=="ipv4" || $addrtype=="ipv6")
	{
		...
		//$dhcpip = query($stsp."/udhcpc/ip/");
		//if($dhcpip!="")
		//{
		//	$foundip = 1;
		//	$str_nb = $str_nb."-r ".$hostname.":".$dhcpip." ";
		//	$str_nb = $str_nb."-r ".$ahostname.":".$dhcpip." ";
		//}
		if($static=="0") 
		{
			//get dhcp retrieved ip
		...
		//{
		//	$foundip = 1;
		//	$str_nb = $str_nb."-r ".$hostname.":".query($stsp."/ipalias/ipv4/ipaddr:".$InDeX)." ";
		//}
