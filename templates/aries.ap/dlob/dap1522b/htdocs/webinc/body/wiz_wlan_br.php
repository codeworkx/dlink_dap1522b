...
<div id="wiz_start" class="orangebox">
	...
	<div class="gap"></div>
	<p>
		<?echo i18n("This wizard is designed to assist you in your Wi-Fi network setup. It will guide you through step-by-step instructions on how to set up your Wi-Fi network and how to make it secure.");?>
	</p>
	<div class="gap"></div>
	<div class="gap"></div>
	<div class="gap"></div>		
	...
	<table align="center">
		<tr>
			<td>
				...
				<b><?echo i18n("WPS");?></b> -- <?echo i18n("Select this option if your wireless device supports WPS (Wi-Fi Protected Setup)");?>
				<br>
				<br>				
				<input id="manual_mode" type="radio" onClick="PAGE.OnChangeConfig('manual');" />&nbsp;
				<b><?echo i18n("Manual");?></b> -- <?echo i18n("Select this option if you want to setup your network manually ");?>
			</td>
		</tr>
	</table>
	<div class="gap"></div>
...
<div id="wps_pbc" class="orangebox">
	...
	<div class="gap"></div>	
	<div class="centerline">	
		<span><?echo i18n("Please press down the Push Button (physical or virtual) on the AP or Router you are connecting to your wireless network within");?></span>
...
<div id="wps_ok" class="orangebox">
	...
	<div class="gap"></div>	
	<p align="center">
		<?echo i18n("You have succeeded to connect to the Wi-Fi network.");?>
	</p>
	<div class="gap"></div>
	<div class="gap"></div>	
	<div class="centerline">
...
<div id="wps_fail" class="orangebox">
	...
	<div class="gap"></div>	
	<p>
		<?echo i18n("You have failed to connect to the add the WI-Fi network within the given timeframe, please click on the button below to do it again.");?>
	</p>
	<div class="gap"></div>
	<div class="gap"></div>	
	<div class="centerline">
...
<!--div id="wps_result" class="orangebox">
	...
	<p class="strong">
		<?echo i18n("Please take a note of the following summary of your Wi-Fi Security for future reference.");?>
	</p>
	<div class="gap"></div>
	<div class="textinput">
		<span class="name"><?echo i18n("Wi-Fi Network Name ");?>(SSID)</span>
		<span class="delimiter">:</span>
	...
	<div class="gap"></div>
	<p class="strong">
		<?echo i18n("The Setup Wizard has completed. Click the Save button to save your settings and reboot the device.");?>
	</p>
	<div class="gap"></div>
	<div class="centerline">
...
<div id="site_survey_scan" class="orangebox">
	<h1><?echo i18n("SELECT WI-FI NETWORK");?></h1>
	<div class="gap"></div>
	<div class="gap"></div>	
	<p align="center">
		<?echo i18n("Scanning to available Wi-Fi network");?>...
	</p>	
	<div class="gap"></div>
	<div class="gap"></div>		
	<div class="gap"></div>	
	<div class="centerline">
		<input type="button" value="<?echo i18n("Prev");?>" onClick="PAGE.OnClickPrev();" />&nbsp;&nbsp;
		<input type="button" value="<?echo i18n("Cancel");?>" onClick="PAGE.OnClickCancel();" />&nbsp;&nbsp;
		<input type="button" value="<?echo i18n("Finish");?>" disabled="disabled" />&nbsp;&nbsp;
	</div>
	<div class="gap"></div>
</div>
...
<div id="site_survey">
	<table id="SiteSurveyTable" name="SiteSurveyTable" border="1">
		<tr bgcolor="#66CCFF">
			<th width="200px"><?echo i18n("Wi-Fi Network Name");?></th>
	...
	<div class="gap"></div>	
	<div class="centerline">
		<input type="button" value="<?echo i18n("Rescan");?>" onClick="PAGE.OnSubmit();" />&nbsp;&nbsp;
		<input type="button" value="<?echo i18n("Connect");?>" onClick="PAGE.OnClickNext();" />&nbsp;&nbsp;
		<input type="button" value="<?echo i18n("Cancel");?>" onClick="PAGE.OnClickCancel();" />&nbsp;&nbsp;
	</div>
	<div class="gap"></div>	
...
<!--div id="wpa_key" class="orangebox">
	...
	<div class="textinput">
		...
		<span class="delimiter">:</span>
		<span class="value">
			<input id="wpa_input" type="text" size="45" maxlength="63" />&nbsp;&nbsp;<?echo i18n("(8 to 63 characters)");?>
		</span>	
	</div>
	<div class="gap"></div>
	<div class="gap"></div>
...
<div id="manual_key" class="orangebox">
	<h1><?echo i18n("ENTER Wi-Fi PASSWORD");?></h1>
	<p>
		<?echo i18n("Please enter Wi-Fi Password to establish wireless connection.");?>
	</p>
	<div class="gap"></div>	
	<div class="textinput">
		<span id="wpa_input_str" class="name"><?echo i18n("Wi-Fi Password");?></span>
		<span class="delimiter">:</span>
		<span class="value">
			<input id="wpa_input" type="text" size="45" />
		</span>	
	</div>
	<div class="gap"></div>
	<div class="gap"></div>
...
<div id="final" class="orangebox">
	...
	<div class="gap"></div>	
	<p align="center">
		<?echo i18n("The Wi-Fi setup wizard has completed.");?>
	</p>
	<div class="gap"></div>
	<div class="gap"></div>	
	<div class="centerline">
