...
<div id="manual" class="orangebox">
	<h1><?echo i18n("WELCOME TO THE D-LINK Wi-Fi SETUP WIZARD");?></h1>
	<p>
		<?echo i18n("Give your Wi-Fi network a name.");?>
	</p>
	<div class="textinput">
		<p><?echo i18n("Wi-Fi Network Name (SSID):");?></p>
	</div>
	<div>
		<p><input id="ssid_input" type="text" size="32" maxlength="32" />
		<?echo i18n("(Using up to 32 characters)");?></p>
	</div>
	<div class="gap"></div>	
	<div>
		<p><?echo i18n("Give your Wi-Fi network a password.");?></p>
	</div>
	<div class="gap"></div>	
	<div class="textinput">
		<p><?echo i18n("Wi-Fi Password:");?></p>
	</div>
	<div>
		<p><input id="key_input" type="text" size="63" maxlength="63" />
		<?echo i18n("(Between 8 and 63 characters)");?></p>
	</div>
	<div class="gap"></div>	
	<div class="centerline">
		<input type="button" value="<?echo i18n("Prev");?>" onClick="PAGE.OnClickPrev();" />&nbsp;&nbsp;
