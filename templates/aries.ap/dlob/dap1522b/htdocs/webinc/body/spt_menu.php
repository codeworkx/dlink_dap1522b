<div class="orangebox">
	...
	<ul>
		...
		<li><a href="./support.php#Maintenance"><?echo i18n("Maintenance");?></a></li>
...
<div class="blackbox">
	...
	<ul>
		...
		<li><a href="./spt_setup.php#Wireless"><?echo i18n("Wireless Setup");?></a></li>
		<li><a href="./spt_setup.php#Network"><?echo i18n("LAN Setup");?></a></li>		
	</ul>
</div>
<div class="blackbox">
	...
	<ul>		
		...
		<li><a href="./spt_adv.php#Network"><?echo i18n("Advanced Wireless");?></a></li>
		<li><a href="./spt_adv.php#Gzone"><?echo i18n("Guest Zone");?></a></li>
		<li><a href="./spt_adv.php#DhcpServer"><?echo i18n("DHCP Server");?></a></li>
		<li><a href="./spt_adv.php#Qos"><?echo i18n("QoS");?></a></li>
		<li><a href="./spt_adv.php#TraMgr"><?echo i18n("Traffic Manager");?></a></li>
		<li><a href="./spt_adv.php#WPS"><?echo i18n("Wi-Fi Protected Setup");?></a></li>
		<li><a href="./spt_adv.php#UserLimit"><?echo i18n("User Limit");?></a></li>
	</ul>
</div>
<div class="blackbox">
	<h2><a name="Maintenance"><?echo i18n("Maintenance Help");?></a></h2>
	<ul>
		...
		<?if ($FEATURE_NOSCH!="1")echo '<li><a href="./spt_tools.php#Schedule">'.i18n("Schedules").'</a></li>\n';?>
	</ul>
</div>
<div class="blackbox">
