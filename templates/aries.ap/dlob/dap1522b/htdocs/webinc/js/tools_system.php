...
Page.prototype =
{
	...
	OnClickUpload: function()
	{
		...
		if(OBJ("ulcfg").value.slice(-4) != ".dcf")
		{
			BODY.ShowAlert("<?echo i18n("File extension error! It must be \\\".dcf\\\" . Please try again!");?>");
			return false;
		}
		OBJ("ulcfgbin").submit();
	},
...
{	
	...
	var msgArray = ["<?echo i18n("If you changed the IP address of the AP or wireless client you will need to change the IP address in your browser before accessing the configuration web page again.");?>"];
	var delay = 10;
