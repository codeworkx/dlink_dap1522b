...
Page.prototype =
{
	...
	{
		var note="", d="";
		if (this.cfg[i].sun=="1") {note+=d+"<?echo i18n("SUN");?>";d=",";}
		if (this.cfg[i].mon=="1") {note+=d+"<?echo i18n("MON");?>";d=",";}
		if (this.cfg[i].tue=="1") {note+=d+"<?echo i18n("TUE");?>";d=",";}
		if (this.cfg[i].wed=="1") {note+=d+"<?echo i18n("WED");?>";d=",";}
		if (this.cfg[i].thu=="1") {note+=d+"<?echo i18n("THU");?>";d=",";}
		if (this.cfg[i].fri=="1") {note+=d+"<?echo i18n("FRI");?>";d=",";}
		if (this.cfg[i].sat=="1") {note+=d+"<?echo i18n("SAT");?>";d=",";}
		return note;
	},
	...
	OnClickSchSubmit: function()
	{
		...
		//check same rule exist or not
			...
			if(update > -1) alert("<?echo i18n("Please reboot the device to make sure the schedule function would work well.");?>");
	...
	OnDelete: function(i)
	{
		alert("<?echo i18n("Please reboot the device to make sure the schedule function would work well.");?>");
		this.cfg.splice(i,1);
		BODY.OnSubmit();
	},
	dummy: function() {}
