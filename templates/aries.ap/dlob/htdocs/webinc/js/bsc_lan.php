...
Page.prototype =
{
	services: "DEVICE.HOSTNAME,INET.BRIDGE-1,INET.BRIDGE-2,INET.BRIDGE-3,RUNTIME.PHYINF",
	OnLoad: function()
	{
	...
	PreSubmit: function()
	{
		...
		if(OBJ("lan_type_v4").value === "lan_static")	
		{
			...
			if(COMM_EqBOOL(OBJ("ipaddr_v4").getAttribute("modified"), true))	this.ipdirty = true;
		}
		else
		{
		...
		/* For IPv4 End */
		/* For IPv6 Start */
		if(OBJ("ipv6_mode").value === "LL")	XS(this.inf_ipv6+"/active",	"0");
