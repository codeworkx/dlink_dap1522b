...
<div class="orangebox">
	...
	<p><?echo i18n("Use this section to configure the wireless settings for your D-Link access point.")." ".
...
<div class="blackbox">
	...
	<div class="textinput">
		...
		<span class="value"><span id="wlan_mode"></span></span>
	</div>
	<div class="textinput">
...
<div id="wep" class="blackbox" style="display:none;">
	...
	<p><?echo i18n("WEP is the wireless encryption standard.")." ".
		i18n("To use it you must enter the same key(s) into the router and the wireless client.")." ".
...
<div id="wpa" class="blackbox" style="display:none;">
	...
	<p><?echo i18n("WPA/WPA2 requires client to use high grade encryption and authentication.");?></p>
	<div class="textinput">
