...
<div id="wps" class="orangebox">
	...
	<div class="centerline">	
		...
		<span id="ct" style="color:red;">120</span>
...
<div id="site_survey">
	<table id="SiteSurveyTable" border="1">
		<tr bgcolor="#66CCFF">
...
<div id="wpa_key" class="orangebox">
	...
	<p>
		<?echo i18n("Please enter the WPA2-Auto personal passphrase to establish wireless connection.");?>
	</p>
	<div class="gap"></div>	
	<div class="textinput">
		<span class="name"><?echo i18n("WPA2-Auto Personal Passphrase ");?></span>
		<span class="delimiter">:</span>
		<span class="value">
