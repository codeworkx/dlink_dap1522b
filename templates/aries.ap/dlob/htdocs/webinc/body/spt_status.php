...
<div class="blackbox">
	...
	<dl>
		...
		<dd><?
			echo i18n("This displays the MAC Address of the Ethernet LAN interface, the IP Address and Subnet Mask of the LAN interface, and whether or not the access point's built-in DHCP server is Enabled or Disabled.");
		?></dd>
		<dt><?echo i18n("WAN (Wide Area Network)");?></dt>
		<dd><?
			echo i18n("This displays the MAC Address of the WAN interface, as well as the IP Address, Subnet Mask, Default Gateway, and DNS server information that the access point has obtained from your ISP. It will also display the connection type (Dynamic, Static, or PPPoE) that is used establish a connection with your ISP. If the access point is configured for Dynamic, then there will be buttons for releasing and renewing the IP Address assigned to the WAN interface. If the access point is configured for PPPoE, there will be buttons for connecting and disconnecting the PPPoE session.");
		?></dd>
...
<div class="blackbox">
	...
	<dl>
		...
		<dd><?echo i18n("Select the type of information you would like the DAP-1525 to log.");?></dd>
		<dt><?echo i18n("Log Level");?></dt>
		<dd><?echo i18n("Select the level of information you would like the DAP-1525 to log.");?></dd>
	</dl>
</div>
<div class="blackbox">
	<h2><a name="Statistics"><?echo i18n("Statistics");?></a></h2>
	<p><?
		echo i18n("The access point keeps statistic of the data traffic that it handles. You are able to view the amount of packets that the access point has Received and Transmitted on the Internet (WAN), LAN, and Wireless interfaces.");
	?></p>
	<dl>
