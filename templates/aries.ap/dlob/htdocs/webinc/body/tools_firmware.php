<div class="orangebox">
	...
	<p>
		<?echo i18n("There may be new firmware for your AP or wireless client to improve functionality and performance.");?><br/>
	...
	?></p>
	<p><?
		echo i18n("The language pack allows you to change the language of the user interface on the AP or wireless client. We suggest that you upgrade your current language pack if you upgrade the firmware. This ensures that any changes in the firmware are displayed correctly.");
	?></p>
	<p><?
