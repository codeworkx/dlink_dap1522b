...
<div id="wps_config" class="orangebox">
	...
	<p align="center"><?echo i18n('Please Enter the above PIN information into your Acces Point and click the below "Connect" button.');?></p>
	<br>
	<div class="textinput">
...
<div id="wps_result" class="orangebox">
	...
	<div class="gap"></div>
		...
		<span class="delimiter">:</span>
		<span class="value" id="key_wps"></span>
	</div>
	<div class="gap"></div>
	<div class="centerline">
...
<div id="manual_result" class="orangebox">
	...
	<div class="gap"></div>
		...
		<span class="name"><?echo i18n("Network Key");?></span>
		<span class="delimiter">:</span>
		<span class="value" id="key_manual"></span>
	</div>
	<div class="gap"></div>
	<div class="centerline">
		<input type="button" value="<?echo i18n("Prev");?>" onClick="PAGE.OnClickPrev();" />&nbsp;&nbsp;
