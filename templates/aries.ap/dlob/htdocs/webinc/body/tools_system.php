<div class="orangebox">
	...
	<p><?echo i18n("Once the AP or wireless client is configured you can save the configuration settings to a configuration file on your hard drive. You also have the option to load configuration settings, or restore the factory default settings.");?></p>
</div>
<div class="blackbox">
