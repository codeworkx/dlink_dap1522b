...
<div class="blackbox">
	<h2><?echo i18n("Wireless Connection Setup Wizard");?></h2>
	<p>
		<?echo i18n("If you would like to utilize easy to use web-based wizard to assist you in connecting your wireless device")." ".
				i18n("to the wireless network, click on the button below.");?>
	</p>
	...
	<p>
		...
		<?echo i18n("Some changes made using this Setup Wizard may require you to change some settings on your wireless client adapters so they can still connect to the D-Link Access Point.");?>
	</p>
</div>
<div class="blackbox">
	...
	<p>
		<?echo i18n("If your wireless network is already set up with Wi-Fi Protected Setup, manual configuration of the wireless network will destroy the existing wireless network.")." ".
				i18n("If you would like to configure the wireless settings of your new D-Link Systems Access Point manually, then click on the Manual Wireless Network Setup button below.");?>
	</p>
	<div class="centerline">
		<input type="button" id="inetsetup" value="<?echo i18n("Manual Wireless Network Setup");?>" onClick='self.location.href="bsc_wlan.php";' usrmode="enable" />
	</div>
