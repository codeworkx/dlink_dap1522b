...
#define __KERNEL_HEADERS__ "/spaces/opt/buildroot/mipsel_gcc-4.3.3_uclibc-0.9.30.1.build/buildroot-2009.08/toolchain_build_mipsel/linux/include"
...
#define __CROSS_COMPILER_PREFIX__ "/opt/mipsel_gcc-4.3.3_uclibc-0.9.30.1/usr/bin/mipsel-linux-uclibc-"
